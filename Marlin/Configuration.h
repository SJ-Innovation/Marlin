...
#define STRING_CONFIG_H_AUTHOR "SJI Uni3D Test" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_UNI3D
#endif
...
#define ENABLE_SPI_TEMP_SENSOR // Enables the SPI temperature sensor module, often used with Uni3D Mosular Interface.
#ifdef ENABLE_SPI_TEMP_SENSOR
  #define SENSOR_0_THERMISTOR_CHANNEL 0   // Set which channel on SPI Controller corresponds to which thermistor. -1 or commented or disabled.
  #define SENSOR_1_THERMISTOR_CHANNEL 1
  #define SENSOR_2_THERMISTOR_CHANNEL 2
//  #define SENSOR_3_THERMISTOR_CHANNEL -1
//  #define SENSOR_4_THERMISTOR_CHANNEL -1
//  #define SENSOR_5_THERMISTOR_CHANNEL -1
  #define SENSOR_BED_THERMISTOR_CHANNEL 3
//  #define SENSOR_CHAMBER_THERMISTOR_CHANNEL -1
#endif
