...
#define HAS_X_ENCODER (defined(X_ENCODER_TIMER_NUM) && X_ENCODER_TIMER_NUM != -1)
#define HAS_Y_ENCODER (defined(Y_ENCODER_TIMER_NUM) && Y_ENCODER_TIMER_NUM != -1)
#define HAS_SPA_ENCODER (defined(SPA_ENCODER_TIMER_NUM) && SPA_ENCODER_TIMER_NUM != -1)
#define HAS_SPB_ENCODER (defined(SPB_ENCODER_TIMER_NUM) && SPB_ENCODER_TIMER_NUM != -1)
